...
fn main() {
    ...
    println!("アサシン bits: bit1={}, bit2={}", assassin_bit1, assassin_bit2);
    ...
    let assassin_cards: Vec<&_> = all_cards
        ...
        .filter(|c| {
            ...
            if assassin_bit2 == 0 || assassin_bit2 == 1 {
                ...
                (feature_bits1 & assassin_bit1) == assassin_bit1 && (feature_bits2 & assassin_bit2) == assassin_bit2
            }
        })
        .collect();
    ...
    if assassin_cards.len() > 0 {
        ...
        for (i, card) in assassin_cards.iter().take(3).enumerate() {
            println!("  {}. {}: bits1={}, bits2={}", i+1, card.1, card.20, card.21);
        }
    }
    ...
    println!("Sランサー bits: bit1={}, bit2={}", slancer_bit1, slancer_bit2);
    ...
    let slancer_cards: Vec<&_> = all_cards
        ...
        .filter(|c| {
            ...
            if slancer_bit2 == 0 || slancer_bit2 == 1 {
                ...
                (feature_bits1 & slancer_bit1) == slancer_bit1 && (feature_bits2 & slancer_bit2) == slancer_bit2
            }
        })
        .collect();
    ...
    println!("組み合わせ bits: bit1={}, bit2={}", combined_bit1, combined_bit2);
    ...
    println!("アサシン AND Sランサーを持つカード数: {}", combined_cards.len());
