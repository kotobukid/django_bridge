                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-blue-500 pl-4">
                            ...
                            <p class="text-gray-600 mb-1">
                                "提供: https://mokuzai.booth.pm/items/3885939"
                            </p>
                            <p class="text-gray-600 mb-1">
                                "ライセンス: SIL Open Font License"
                            </p>
                            <pre>
r#####"This Font Software is licensed under the SIL Open Font License, Version 1.1.
...
OTHER DEALINGS IN THE FONT SOFTWARE."#####
                        ...
                        //     </h3>
                        //     <p class="text-gray-600 mb-1">
                        //         "提供: Google Fonts / M+ FONTS PROJECT"
                        //     </p>
                        //     <p class="text-gray-600 mb-1">
                ...
                //             </p>
                //             <a
                //                 href="https://www.takaratomy.co.jp/products/wixoss/"
                //                 target="_blank"
                //                 rel="noopener noreferrer"
                //                 class="text-blue-600 hover:underline"
                //             >
